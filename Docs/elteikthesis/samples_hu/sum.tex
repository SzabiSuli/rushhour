...
Az állapottérbeli keresésre 3 alapvető algoritmus került implementálásra, amelyekkel jól ábrázolhatóak egy probléma különböző megközelítései. Arra is alkalmas a rendszer, hogy egy saját algoritmust látványosan tudjunk futtatni, és elemezzük annak viselkedését, ellenőrizzük az elvárt helyességét. 

\paragraph{Bővítési lehetőségek.} Számos területen lehet még tovább fejleszteni az alkalmazást:
\begin{compactitem}
...
\item Algoritmus által megtalált megoldás lejátszása a játék táblán.
\item Visszalépéses keresés mélységi korlátának implementálása.
\item Az alkalmazás átstruktúrálása MVVM (Model-View-ViewModel) architektúrába.
\end{compactitem}