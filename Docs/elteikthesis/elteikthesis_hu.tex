...
% Document's metadata
\title{Keresőalgoritmusok interaktív alkalmazása és állapotgráfok ábrázolása} % title
\date{2026} % year of defense

% Author's metadata
\author{Szécsi Szabolcs Ádám}
\degree{Programtervező informatikus BSc}

% Superivsor(s)' metadata
\supervisor{Dr. Gregorics Tibor} % internal supervisor's name
\affiliation{Tanszékvezető egyetemi docens} % internal supervisor's affiliation
